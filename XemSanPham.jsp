	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content">
				...
				<div class="row">
					<div class="col-sm-4">
						<img src="admin/dist/img/rebel300.1.jpg" style="width: 100%">
					</div>
					<div class="col-sm-4">
						<img src="admin/dist/img/rebel300.2.jpg" style="width: 100%">
					</div>
					<div class="col-sm-4">
						<img src="admin/dist/img/rebel300.3.jpg" style="width: 100%">
					</div>
				</div>
