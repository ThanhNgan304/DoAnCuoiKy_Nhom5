  ...
  <div class="content-wrapper">
    ...
    <section class="content">
            ...
            <div class="row">
                    ...
                    <div class="col-xs-8">
                        <div class="box">
                            <div class="box-header text-center"> Phiáº¿u nháº­p hÃ ng</div>
                            <div class="box-body">
                                <form class="form-horizontal">
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">MÃ£ phiáº¿u:</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" placeholder="MÃ£" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                                <label class="col-sm-2 control-label">TÃªn xe:</label>
            
                                                <div class="col-sm-10">
                                                    <select class="form-control select2 select2-hidden-accessible" style="width: 100%;"
                                                        tabindex="-1" aria-hidden="true">
                                                        <option selected="selected">Exeter 150</option>
                                                        <option>Exeter 150</option>
                                                        <option>Winner 150</option>
                                                        <option>Raider 150</option>
                                                    </select>
                                                </div>
            
                                            </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">NgÃ y nháº­p:</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">GiÃ¡ nháº­p:</label>
                                            <div class="col-sm-9">
                                                
                                                <input type="number" class="form-control" placeholder="GiÃ¡ tiá»n" required>
                                            </div>
                                            <div class="col-sm-1">
                                                <label class="control-label">.VNÄ</label>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Sá» lÆ°á»£ng:</label>
                                            <div class="col-sm-10">
