                    ...
                    <div class="col-md-8">
                        <div class="box box-info">
                            <div class="box-header with-border">
                                <h3 class="box-title">ThÃªm sáº£n pháº©m</h3>
                            </div>
                            <!-- /.box-header -->
                            <!-- form start -->
                            <form class="form-horizontal">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">MÃ£ xe mÃ¡y:</label>
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">TÃªn xe mÃ¡y:</label>

                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" placeholder="TÃªn" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">ÄÆ¡n giÃ¡:</label>
                                ...
                                <div class="box-footer">
                                    <a href="SanPham.html"><button type="button" class="btn btn-danger"><i class="fa fa-trash-o"></i> Há»§y bá»</button></a>
                                    <button type="submit" class="btn btn-info pull-right"><i class="fa fa-save"></i> HoÃ n táº¥t</button>
                                </div>
                                <!-- /.box-footer -->
                            </form>
                        </div>
